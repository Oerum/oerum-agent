...
5. **Create Release**:
   ...
   - Create the release using the GitHub CLI: `gh release create v<VERSION> --generate-notes`.
...
7. **Notify User**:
   - Only after the assets are fully uploaded, notify the user that the release is published and ready for download.
